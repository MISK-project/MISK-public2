...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 331.0, 252.0, 130.0, 22.0 ],
									"text" : "scale 0. 127. 1. 0.8 1.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 270.0, 79.0, 130.0, 22.0 ],
									"text" : "scale 0. 127. 1. 127. 2."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 199.0, 190.0, 42.0, 22.0 ],
									"text" : "gate 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 199.0, 79.0, 26.0, 22.0 ],
									"text" : "> 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 199.0, 14.0, 195.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 49.0, 286.0, 32.0, 22.0 ],
									"text" : "tanh"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 43.0, 14.0, 125.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 51.0, 414.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									"destination" : [ "obj-8", 1 ],
									"midpoints" : [ 52.5, 183.0, 231.5, 183.0 ],
									"source" : [ "obj-1", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-3", 1 ],
									"midpoints" : [ 279.5, 243.0, 69.0, 243.0 ],
									"source" : [ "obj-11", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-3", 0 ],
									"midpoints" : [ 208.5, 243.0, 58.5, 243.0 ],
									"source" : [ "obj-8", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-4", 0 ],
									"midpoints" : [ 231.5, 399.0, 60.5, 399.0 ],
									"source" : [ "obj-8", 1 ]
								}
...
,
					"patching_rect" : [ 48.0, 942.0, 122.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ -8.0, 874.0, 25.0, 36.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 197.0, 118.0, 128.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 72.0, 923.0, 80.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 212.0, 165.0, 50.0, 22.0 ],
					"text" : "0",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 534.5, 310.0, 128.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 247.0, 919.0, 25.0, 36.0 ],
					"presentation" : 1,
...
,
									"fileref" : 									{
										"name" : "synth_simple.rnbopat",
										"filename" : "synth_simple.rnbopat_20241120.maxsnap",
										"filepath" : "/Users/Github/Max-patches/MISK_b6/data",
										"filepos" : -1,
										"snapshotfileid" : "75b0919058c4a16fa6b03f5e9c821a8b"
									}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 204.0, 395.0, 131.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 710.0, 984.0, 25.0, 36.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 48.0, 997.0, 71.5, 22.0 ],
					"text" : "biquad~",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 1146.0, 30.0, 30.0 ],
					"style" : "MISK2"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 461.5, 621.0, 57.5, 621.0 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 0 ],
					"midpoints" : [ 213.5, 645.0, 57.5, 645.0 ],
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-36", 0 ],
					"midpoints" : [ 1.5, 942.0, 45.0, 942.0, 45.0, 939.0, 57.5, 939.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 0 ],
					"midpoints" : [ 289.5, 648.0, 57.5, 648.0 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 0 ],
					"midpoints" : [ 358.5, 595.0, 57.5, 595.0 ],
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 0 ],
					"midpoints" : [ 256.5, 847.0, 57.5, 847.0 ],
					"source" : [ "obj-49", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 258.0, 689.0, 257.0, 689.0, 257.0, 701.0, 256.5, 701.0 ],
					"source" : [ "obj-50", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 0 ],
					"midpoints" : [ 358.5, 691.0, 57.5, 691.0 ],
					"source" : [ "obj-51", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 0 ],
					"midpoints" : [ 554.5, 730.0, 57.5, 730.0 ],
					"source" : [ "obj-52", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 0 ],
					"midpoints" : [ 377.5, 975.0, 354.0, 975.0, 354.0, 912.0, 300.0, 912.0, 300.0, 830.0, 57.5, 830.0 ],
					"source" : [ "obj-56", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 0 ],
					"midpoints" : [ 208.5, 1029.0, 180.0, 1029.0, 180.0, 888.0, 33.0, 888.0, 33.0, 840.0, 57.5, 840.0 ],
					"source" : [ "obj-60", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 256.5, 957.0, 354.0, 957.0, 354.0, 915.0, 377.5, 915.0 ],
					"source" : [ "obj-63", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 420.5, 506.0, 425.0, 506.0, 425.0, 566.0, 332.0, 566.0, 332.0, 884.0, 194.0, 884.0, 194.0, 914.0, 208.5, 914.0 ],
					"order" : 9,
					"source" : [ "obj-65", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 420.5, 507.0, 426.0, 507.0, 426.0, 567.0, 324.0, 567.0, 324.0, 915.0, 256.5, 915.0 ],
					"order" : 7,
					"source" : [ "obj-65", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 0 ],
					"midpoints" : [ 719.5, 1098.0, 429.0, 1098.0, 429.0, 984.0, 354.0, 984.0, 354.0, 912.0, 300.0, 912.0, 300.0, 823.0, 57.5, 823.0 ],
					"source" : [ "obj-76", 0 ]
				}
...
,
		...
		"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
		"textcolor_inverse" : [ 0.102046459913254, 0.091540455818176, 0.095082558691502, 1.0 ],
