...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 390.0, 125.0, 29.5, 22.0 ],
					"text" : "t i b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 950.0, 840.0, 29.5, 22.0 ],
					"text" : "#1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 950.0, 879.0, 206.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 568.375, 749.0, 110.25, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.375, 227.0, 111.625, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "Select extra function", "Trigger movieclip", "Next movieclip", "Photo" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 611.5, 471.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 611.5, 432.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 662.0, 389.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 662.0, 471.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 177.0, 158.0, 76.0, 22.0 ],
					"text" : "r polyplaying"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 573.0, 633.0, 69.0, 22.0 ],
					"text" : "prepend #1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 573.0, 712.0, 61.0, 22.0 ],
					"text" : "s sp_start"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 390.0, 186.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 83.0, 96.0, 69.0, 22.0 ],
					"text" : "prepend #1"
				}
...
, 			{
				"box" : 				{
					"decodemode" : 1,
					"id" : "obj-3",
					"legend" : "drop image/movie here",
					"maxclass" : "live.drop",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 83.0, 42.0, 119.0, 39.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
,
					"patching_rect" : [ 495.0, 382.0, 91.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 573.0, 596.0, 52.0, 22.0 ],
					"text" : "gate 1 0",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 526.0, 471.0, 49.5, 22.0 ],
					"text" : "t b l",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 556.5, 511.0, 85.0, 22.0 ],
					"text" : "prepend prefix",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 504.5, 456.0, 492.0, 456.0, 492.0, 417.0, 621.0, 417.0 ],
					"source" : [ "obj-105", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 398.5, 81.0, 768.5, 81.0 ],
					"order" : 0,
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 399.5, 258.0, 273.0, 258.0, 273.0, 465.0, 254.0, 465.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 504.5, 420.0, 504.5, 420.0 ],
					"source" : [ "obj-243", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 576.5, 420.0, 480.0, 420.0, 480.0, 591.0, 582.5, 591.0 ],
					"source" : [ "obj-243", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 14.5, 177.0, 162.0, 177.0, 162.0, 93.0, 270.0, 93.0, 270.0, 3.0, 293.5, 3.0 ],
					"order" : 3,
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 293.5, 111.0, 429.0, 111.0, 429.0, 213.0, 454.25, 213.0 ],
					"source" : [ "obj-64", 0 ]
				}
