...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 393.0, 462.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 393.0, 487.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 255.5, 426.5, 39.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 359.0, 435.0, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 377.0, 16.0, 38.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2325.0, 617.0, 41.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 256.0, 13.5, 79.0, 20.0 ],
					"text" : "Set threshold"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 347.0, 734.0, 49.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 347.0, 765.0, 207.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 359.0, 522.5, 63.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 359.0, 569.0, 87.0, 22.0 ],
					"text" : "autosustain $1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 348.0, 13.5, 25.0, 20.0 ],
					"text" : "Off",
					"texton" : "On"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 139.0, 841.0, 50.0, 35.0 ],
					"text" : "1.661417"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 150.0, 969.0, 50.0, 35.0 ],
					"text" : "1.661417"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 280.0, 765.0, 19.0, 22.0 ],
					"text" : "t l"
				}
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_longname" : "live.numbox[1649]",
							"parameter_modmode" : 3,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 2325.0, 653.5, 196.0, 34.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 252.0, 14.0, 83.0, 19.0 ]
				}
...
,
					"patching_rect" : [ 272.5, 580.0, 67.0, 22.0 ],
					"text" : "p envelope"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 286.5, 521.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 235.5, 521.0, 39.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outputmode" : 1,
					"parameter_enable" : 0,
					"patching_rect" : [ 274.0, 620.0, 200.0, 100.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 255.5, 488.0, 37.0, 22.0 ],
					"text" : "* 127"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 252.0, 12.0, 91.0, 24.0 ],
					"style" : "MISK2"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 143.5, 381.0, 126.0, 381.0, 126.0, 552.0, 102.0, 552.0, 102.0, 828.0, -0.5, 828.0 ],
					"source" : [ "obj-138", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-158", 0 ],
					"midpoints" : [ 148.5, 552.0, 345.0, 552.0, 345.0, 510.0, 368.5, 510.0 ],
					"order" : 0,
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 148.5, 552.0, 261.0, 552.0, 261.0, 606.0, 283.5, 606.0 ],
					"order" : 2,
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 356.5, 788.0, 309.0, 788.0, 309.0, 731.0, 261.0, 731.0, 261.0, 614.0, 283.5, 614.0 ],
					"source" : [ "obj-162", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 164.5, 612.0, 114.0, 612.0, 114.0, 615.0, 108.0, 615.0, 108.0, 693.0, 143.5, 693.0 ],
					"source" : [ "obj-185", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 245.0, 752.0, 289.5, 752.0 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.774090170860291, 0.0, 0.0, 1.0 ],
					"destination" : [ "obj-136", 0 ],
					"midpoints" : [ 330.0, 605.0, 261.0, 605.0, 261.0, 752.0, 289.5, 752.0 ],
					"source" : [ "obj-31", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 282.0, 590.0, 283.5, 590.0 ],
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-31", 0 ],
					"midpoints" : [ 506.5, 552.0, 282.0, 552.0 ],
					"order" : 0,
					"source" : [ "obj-49", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"midpoints" : [ 2334.5, 690.0, 2229.0, 690.0, 2229.0, 522.0, 2252.5, 522.0 ],
					"source" : [ "obj-63", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 2309.5, 588.0, 2334.5, 588.0 ],
					"order" : 0,
					"source" : [ "obj-85", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 343.833333333333371, 728.0, 261.0, 728.0, 261.0, 551.0, 330.0, 551.0 ],
					"source" : [ "obj-9", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 2512.5, 305.5, 4.5, 305.5 ],
					"order" : 1,
					"source" : [ "obj-95", 0 ]
				}
